...
namespace GUI
{
    public partial class Form1 : Form
    {
        ...
        {
            BanHang.BanHang banHang = new BanHang.BanHang();
            banHang.ShowDialog();
        }

        private void btnNhap_Click(object sender, EventArgs e)
        {
            NhapHang.NhapHang nhapHang = new NhapHang.NhapHang();
            nhapHang.ShowDialog();
        }
        ...
        {
            ThongKe.BaoCaoTongHop.BaoCaoTongHop th = new ThongKe.BaoCaoTongHop.BaoCaoTongHop();
            th.ShowDialog();
        }
    }
}
