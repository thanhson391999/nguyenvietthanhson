...
namespace eShopSolution.Application.Catalog.Products.Implements
{
    public class ProductService : IProductService
    {
        ...
        public ProductService(EShopDbContext context, IFileStorageService fileStorageService)
        {
        ...
        public async Task<int> AddImage(int productId, ProductImageCreateRequest request)
        {
            ...
            if (product == null || request.ImageFile == null)
            {
        ...
        public async Task<List<ProductImageViewModel>> GetAllImage(int productId)
        {
            ...
            var productImageViewModels = productImages.Select(x => new ProductImageViewModel()
            {
                Id = x.Id,
                Caption = x.Caption,
        ...
        public async Task<PagedResult<ProductViewModel>> GetAllPagingByCategoryId(string languageId, GetPublicProductPagingRequest request)
        {
            // Select join
            var query = from p in _context.Products
                        join pt in _context.ProductTranslations on p.Id equals pt.ProductId
        ...
        public async Task<ProductImageViewModel> GetByIdImage(int imageId)
        {
